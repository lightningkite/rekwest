...
import com.lightningkite.kotlinx.exception.ElementAlreadyExistsException
...
import com.lightningkite.kotlinx.server.base.invocation
import com.lightningkite.kotlinx.server.base.security.HashedFieldRules
import com.lightningkite.kotlinx.server.base.security.PropertySecureTable

object TestUserTable : PropertySecureTable<User, Long>(
        underlying = InMemoryDatabase.table(User::class.kxReflect)
) {
    ...
    val emailRules = object : PropertyRules<User, String> {
        override val variable: KxField<User, String> = UserReflection.Fields.email
    ...
    val roleRules = object : PropertyRules<User, User.Role> {
        override val variable: KxField<User, User.Role> = UserReflection.Fields.role
        override suspend fun query(untypedUser: Any?) {}
        override suspend fun read(untypedUser: Any?, justInserted: Boolean, currentState: User): Boolean = true
    ...
    override val propertyRules: Map<KxField<User, *>, PropertyRules<User, *>> = listOf<PropertyRules<User, *>>(
            passwordRules,
            emailRules,
            roleRules
