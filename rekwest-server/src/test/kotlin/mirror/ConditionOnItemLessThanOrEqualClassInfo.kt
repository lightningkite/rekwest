...
object ConditionOnItemLessThanOrEqualClassInfo: ClassInfo<ConditionOnItem.LessThanOrEqual<*,*>> {
   ...
   val fieldField = FieldInfo<ConditionOnItem.LessThanOrEqual<*,*>, com.lightningkite.mirror.info.FieldInfo<kotlin.Any, kotlin.Comparable<kotlin.Comparable<*>>>>(this, "field", Type<com.lightningkite.mirror.info.FieldInfo<kotlin.Any, kotlin.Comparable<kotlin.Comparable<*>>>>(com.lightningkite.mirror.info.FieldInfo::class, listOf(TypeProjection(Type<kotlin.Any>(kotlin.Any::class, listOf(), false), TypeProjection.Variance.INVARIANT), TypeProjection(Type<kotlin.Comparable<kotlin.Comparable<*>>>(kotlin.Comparable::class, listOf(), false), TypeProjection.Variance.INVARIANT)), false), false, { it.field as com.lightningkite.mirror.info.FieldInfo<kotlin.Any, kotlin.Comparable<kotlin.Comparable<*>>>}, listOf())
    val fieldValue = FieldInfo<ConditionOnItem.LessThanOrEqual<*,*>, kotlin.Comparable<kotlin.Comparable<*>>>(this, "value", Type<kotlin.Comparable<kotlin.Comparable<*>>>(kotlin.Comparable::class, listOf(), false), false, { it.value as kotlin.Comparable<kotlin.Comparable<*>>}, listOf())

   override val fields:List<FieldInfo<ConditionOnItem.LessThanOrEqual<*,*>, *>> = listOf(fieldField, fieldValue)
