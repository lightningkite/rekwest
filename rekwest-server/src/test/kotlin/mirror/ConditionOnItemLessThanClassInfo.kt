...
object ConditionOnItemLessThanClassInfo: ClassInfo<ConditionOnItem.LessThan<*,*>> {
   ...
   object Fields {
       val field = FieldInfo<ConditionOnItem.LessThan<*,*>, com.lightningkite.mirror.info.FieldInfo<kotlin.Any, kotlin.Comparable<kotlin.Comparable<*>>>>(ConditionOnItemLessThanClassInfo, "field", Type<com.lightningkite.mirror.info.FieldInfo<kotlin.Any, kotlin.Comparable<kotlin.Comparable<*>>>>(com.lightningkite.mirror.info.FieldInfo::class, listOf(TypeProjection(Type<kotlin.Any>(kotlin.Any::class, listOf(), false), TypeProjection.Variance.INVARIANT), TypeProjection(Type<kotlin.Comparable<kotlin.Comparable<*>>>(kotlin.Comparable::class, listOf(), false), TypeProjection.Variance.INVARIANT)), false), false, { it.field as com.lightningkite.mirror.info.FieldInfo<kotlin.Any, kotlin.Comparable<kotlin.Comparable<*>>>}, listOf())
        val value = FieldInfo<ConditionOnItem.LessThan<*,*>, kotlin.Comparable<kotlin.Comparable<*>>>(ConditionOnItemLessThanClassInfo, "value", Type<kotlin.Comparable<kotlin.Comparable<*>>>(kotlin.Comparable::class, listOf(), false), false, { it.value as kotlin.Comparable<kotlin.Comparable<*>>}, listOf())
   }

   override val fields:List<FieldInfo<ConditionOnItem.LessThan<*,*>, *>> = listOf(Fields.field, Fields.value)
